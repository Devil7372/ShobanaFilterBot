...
#ALERT FN IN SPELL CHECK FOR LANGAUGES TO KNOW HOW TO TYPE MOVIES esp english spell check goto adv spell check to check donot change the codes      
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴀʙᴏᴜᴛ', callback_data='about')
             ...
             InlineKeyboardButton(f'sᴜᴘᴘᴏʀᴛ', url='https://t.me/ogBestFriends'),
             InlineKeyboardButton(f'ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ', url='https://t.me/BOTxUPDATE')
         ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/ogBestFriends')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('SUPPORT', url='https://t.me/ogBestFriends')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
